                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ url('user/update') }}/{{$user->id}}">
                            ...
                            <div class="form-group">
                                ...
                                <input minlength="8" maxlength="20" id="password" type="password" class="password-field form-control @error('password') is-invalid @enderror" name="password" autocomplete="new-password" placeholder="Password">
