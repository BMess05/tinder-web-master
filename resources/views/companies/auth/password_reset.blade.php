        ...
        <div class="header-body text-center mb-7">
          <div class="row justify-content-center">
            <div class="col-xl-5 col-lg-6 col-md-8 px-5">
              ...
              <p class="text-lead text-white">Reset password and manage the dasboard from panel</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="col-lg-5 col-md-7">
          <div class="card bg-secondary border-0 mb-0">
            <div class="card-body px-lg-5 py-lg-5">
              ...
              <form id="reset-password-form" method="POST" action="{{ route('companyUpdatePassword') }}">
                @csrf
...
{!! JsValidator::formRequest('App\Http\Requests\PasswordSetRequest', '#reset-password-form'); !!}
@endsection