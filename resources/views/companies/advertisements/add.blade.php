                ...
                <div class="card">
                    <div class="card-header border-0">
                        <div class="row align-items-center">
                            <div class="col">
                                <h3 class="mb-0">Add Advertisement</h3>
                            </div>
                    ...
                    <div class="card-body">
                        ...
                        @endif
                        <form id="advertisementForm" method="POST" action="{{ route('saveAdvertisement') }}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    <input maxlength="50" id="title" type="text" class="form-control @error('title') is-invalid @enderror ad_title" name="title" value="{{ old('title') }}" autocomplete="title" placeholder="Title" autofocus>
                                    @error('title')
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror ad_descripton" placeholder="Description">{{ old('description') }}</textarea>
                                    @error('description')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                <div class="input-group input-group-merge input-group-alternative mb-3">
                                    <input maxlength="50" id="url" type="text" class="form-control @error('url') is-invalid @enderror ad_url" name="url" value="{{ old('url') }}" autocomplete="url" placeholder="URL: http://example.com" autofocus>
                                    @error('url')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-merge input-group-alternative mb-3">
                                            <input id="autocomplete" type="text" class="form-control @error('preferred_location') is-invalid @enderror" name="preferred_location" value="{{ old('preferred_location') }}" placeholder="Preferred location" autofocus>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-merge input-group-alternative mb-3">
                                            <input min="1" type="number" class="form-control @error('diameter') is-invalid @enderror" name="diameter" value="{{ old('diameter') }}" autocomplete="diameter" placeholder="Diameter in Kilometers" step="0.1" autofocus>
                                            @error('diameter')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-merge input-group-alternative mb-3">
                                            <input type="number" class="form-control @error('age_from') is-invalid @enderror" name="age_from" value="{{ old('age_from') ?? 18 }}" min=18 max=100>
                                            @error('age_from')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group input-group-merge input-group-alternative mb-3">
                                            <input type="number" class="form-control @error('age_to') is-invalid @enderror" name="age_to" value="{{ old('age_to') ?? 18 }}" min=18 max=100>
                                            @error('age_to')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
                            ...
                            <div class="text-right">
                                ...
                                <button type="submit" class="btn btn-primary mt-3 submit-btn">Save</button>
                            </div>
                        </form>
                    </div>
                </div>
...
$(document).on('submit', '#advertisementForm', function(e) {
    if(($('#lat').val() == "") || ($('#long').val() == "")) {
        e.preventDefault();
        $('.no_lat_long').text('Please select a valid Address.');
        return false;
    }   else {
        $('.no_lat_long').text('');
    }
